...
- Stilyan Penchev (5749131): Implemented kubernetes connectivity check to the ansible finalization playbook. PR: <https://github.com/doda25-team12/operation/pull/30>. Added helm charts for hpa. PR:https://github.com/doda25-team12/operation/pull/28
